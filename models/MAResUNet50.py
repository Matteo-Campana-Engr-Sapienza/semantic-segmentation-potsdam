...
class MAResUNet50_SS(nn.Module):
    def __init__(self,
        ...
        super(MAResUNet50_SS, self).__init__()
        self.name = 'MAResUNet50_SS'
...
def MAResUNet50_SS_(num_channels=3,num_classes = 6,pretrain = "imagenet"):
    return MAResUNet50_SS(num_channels=num_channels, num_classes=num_classes, decoder_block=decoder_block, layers=[3, 6, 4, 3],pretrain = pretrain)
# <--------------------------------------------------------
